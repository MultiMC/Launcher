...
UpdateDialogGtk::UpdateDialogGtk() : m_hadError(false)
{
}
...
gboolean UpdateDialogGtk::notify(void *_message)
{
	...
	case UpdateMessage::UpdateProgress:
		gtk_progress_bar_set_fraction(GTK_PROGRESS_BAR(dialog->m_progressBar),
	...
	case UpdateMessage::UpdateFailed:
	{
		...
		GtkWidget *errorDialog = gtk_message_dialog_new(
			GTK_WINDOW(dialog->m_window), GTK_DIALOG_DESTROY_WITH_PARENT, GTK_MESSAGE_ERROR,
			GTK_BUTTONS_CLOSE, "%s", errorMessage.c_str());
