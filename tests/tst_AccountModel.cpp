...
private slots:
	...
	void test_Querying()
	{
		...
		BaseAccount *account = model->get(model->index(0, 0));
		QVERIFY(account);
	...
	void test_Defaults()
	{
		...
		BaseAccount *acc1 = model->get(model->index(0, 0));
		BaseAccount *acc2 = model->get(model->index(1, 0));
		BaseAccount *accNull = nullptr;
		QVERIFY(acc1);
		QVERIFY(acc2);

		// no default set
		QCOMPARE(model->get("minecraft"), accNull);
		QCOMPARE(model->get("minecraft", instance1), accNull);
		QCOMPARE(model->get("minecraft", instance2), accNull);
		QCOMPARE(model->get("asdf"), accNull);
		QCOMPARE(model->get("asdf", instance1), accNull);
		QCOMPARE(model->get("asdf", instance2), accNull);

		model->setInstanceDefault(instance1, acc1);
		// instance default
		QCOMPARE(model->get("minecraft"), accNull);
		QCOMPARE(model->get("minecraft", instance1), acc1);
		QCOMPARE(model->get("minecraft", instance2), accNull);
		QCOMPARE(model->get("asdf"), accNull);
		QCOMPARE(model->get("asdf", instance1), accNull);
		QCOMPARE(model->get("asdf", instance2), accNull);
		...
		// global default
		QCOMPARE(model->get("minecraft"), acc2);
		QCOMPARE(model->get("minecraft", instance1), acc1);
		QCOMPARE(model->get("minecraft", instance2), acc2);
		QCOMPARE(model->get("asdf"), accNull);
		QCOMPARE(model->get("asdf", instance1), accNull);
		QCOMPARE(model->get("asdf", instance2), accNull);
