...
QList<BasePage *> LegacyInstance::getPages()
{
	...
	values.append(new ModFolderPage(QuickModInstanceModList::Mods, this, loaderModList(), "mods", "plugin-blue", tr("Loader mods"),
									"Loader-mods"));
	values.append(new ModFolderPage(QuickModInstanceModList::CoreMods, this, coreModList(), "coremods", "plugin-green", tr("Core mods"),
									"Core-mods"));
