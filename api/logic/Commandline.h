 ...
 */
LAUNCHER_LOGIC_EXPORT QStringList splitArgs(QString args);
 ...
 */
class LAUNCHER_LOGIC_EXPORT ParsingError : public std::runtime_error
{
public:
 ...
 */
class LAUNCHER_LOGIC_EXPORT Parser
{
public:
    /**
