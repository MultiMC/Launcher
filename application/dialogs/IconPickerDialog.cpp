    ...
    : QDialog(parent), ui(new Ui::IconPickerDialog)
{
    ...
    contentsWidget->setModel(LauncherPtr->icons().get());
...
void IconPickerDialog::addNewIcon()
{
    ...
    LauncherPtr->icons()->installIcons(fileNames);
}

void IconPickerDialog::removeSelectedIcon()
{
    LauncherPtr->icons()->deleteIcon(selectedIconKey);
}
...
{
    DesktopServices::openDirectory(LauncherPtr->icons()->getDirectory(), true);
}
