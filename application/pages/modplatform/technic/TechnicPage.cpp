...
void TechnicPage::suggestCurrent()
{
    ...
    else
    {
        ...
        netJob->addNetAction(Net::Download::makeByteArray(QString("https://api.technicpack.net/modpack/%1?build=%2".arg(slug).arg(LAUNCHER_BUILD_NAME.toLower()), response.get()));
